...
const Crops = ({ setCartItems }) => {
  ...
  useEffect(() => {
    const fetchVegetables = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/products/type/crop');
      ...
      <header className="header">
        <nav className="nav">
          <ul>
            ...
            <li><Link to="/crops">Grocery</Link></li>
